class Calculator{
    ...
    //? Este método adicona valores à propriedade displayValue
    ...
    //? este métado limpa os valores do displayValue (input) e chama o método updateDisplay para atualizar o visor(input)
    clearDisplay(){
        this.displayValue = " ";
        this.updateDisplay();
    }
